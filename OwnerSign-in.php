    ...
    <section class="form my-4 mx-5">
        <div class="container">
            <div class="row">
                ...
                <h4 class="font-weight-bold py-3">OWNER SIGN UP </h4>
                <form action="OwnerSign-upDBC.php" method="POST" onsubmit="return validation()">
                            <div class="form-row">
                                <div class="col-lg-10">
<!--                                    <input type="radio"  id="owner" name="type" value="Venue" checked="checked">&nbsp;&nbsp;<b>Venue</b>-->
<!--                                    <input type="radio" id="vendor" name="type" value="Vendor" >&nbsp;&nbsp;<b>Vendor</b>-->
                                    <br><br>
                                </div>
                            </div>
                        <div class="form-row">
                    ...
                    <p>Already have an account ? <a class="SULink" href="Sign-in.php">Sign in</a></p>
                    </form>
