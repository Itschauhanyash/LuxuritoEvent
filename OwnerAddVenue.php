...
<html lang="en">
    ...
    <body>
        ...
        <!-- ***** Main Block start ***** -->
        <section class="form section-bg" id="call-to-action" style="background-color: #212529">
            <div class="container">
                <div class="row">

                    <form action="OwnerAddVenueDBC.php" method="POST" onsubmit="return validation()" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12 ">
                            <button type="submit" name="sgninBtn" class="btn1 mt-3 mb-5"> Add Venue</button>
                        </div>
                        <?php
