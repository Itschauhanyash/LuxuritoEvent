                ...
                <div class="row">
                    <div class="container">
                        ...
                        <div class="row" style="display: inline-flex;">
                            ...
                            $prj = "SELECT * FROM eventbooking WHERE Check_out_date >= date(now())AND C_ID = $C_id";
                            $stmt = $con->query($prj);
                            if ($stmt) {
                ...
                <div class="row">
                    <div class="container">
                        ...
                        <div class="row" style="display: inline-flex;">
                            ...
                            $Date = date('Y-m-d');
                            //query to get all venue whose customer id is as above
                            $prj1 = "SELECT * FROM eventbooking WHERE Check_out_date <= date(now()) AND C_ID= $C_id";
                                ...
                                <div class="col-md-4">
                                    <div class="trainer-item">
                                        <div class="image-thumb1">
                                            <?php
                                            $idvenue1 = $rec1;
                                            $srcimg1 = mysqli_query($con, "Select * FROM Eventimage where Venue_ID = $idvenue1");
                                            while ($row1 = $srcimg1->fetch_assoc()) {
                                                $id1 = $row1['Venue_Image'];
                                                echo "<img src=\"assets/images/" . "$id1\" >";
                                            }
                                            ?>
                                        </div>
                                        <div class="down-content">
                                            <h4>
                                                <?php
                                                $idvenue1 = $rec1;
                                                $srcprice1 = mysqli_query($con, "Select * FROM event where Event_ID = $idvenue1");
