...
if (isset($_POST['cancel'])) {
    ...
    $getdate = mysqli_query($con, "Select * FROM eventbooking where Booking_ID = $bookingid");
    ...
    $delete =  mysqli_query($con,"DELETE FROM `eventbooking` WHERE `Booking_ID` = $bookingid");

    if($delete){
        $msg = "Your Booking Cancel.";
