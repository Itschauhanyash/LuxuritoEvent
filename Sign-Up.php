            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10">
                        ...
                        <h4 class="font-weight-bold py-3">Sign Up As Client</h4>
                        <form action="SignUpDBC.php"  method="post" onsubmit="return validation()">
                            <div class="form-row">
                                <div class="col-lg-10">
                                    <label>Name</label>
                            ...
                            <div class="form-row">
                                <div class="col-lg-10">
                                    ...
                                    <input type="radio"  id="male" name="gender" value="male" checked="checked">&nbsp;&nbsp;<b>MALE</b>
