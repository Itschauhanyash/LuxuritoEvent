     ...
     if(isset($_POST["sgninBtn"]))
        {
            ...
            $add_recV = "INSERT INTO venue (Venue_Name,Venue_Description,Venue_Address,Price_PerDay,VType_ID,O_ID)VALUES('$Venue_Name','$Venue_Description','$Venue_Address','$Price','$VType_ID','$O_ID')";           
            ...
            if($qryReturn == TRUE)
            {
                ...
                if($qryReturn1 == true)
                {
                    ...
                    header('Refresh: 0; url=OwnerViewVenue.php');
                }
                else{
                    echo $con->error;
                }  
