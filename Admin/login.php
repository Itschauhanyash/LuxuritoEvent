...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT A_ID FROM admin WHERE A_Email=:username and A_Password=:password";
...
<html lang="en" class="no-focus"> <!--<![endif]-->
    <head>       
        <title>Luxurito Event - Admin Login Page</title>
...
<!--                                <p class="font-italic text-white-op">
                                    Copyright &copy; <span class="js-year-copy">2020-21</span>
                                </p>-->
                            </div>
                        </div>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="login.php">
                                        ...
                                        <span class="font-size-xl">Luxurito Event</span>
                                    </a>
