...
if (isset($_POST['sgninBtn'])) {
    ...
    $Password = $_POST['sgninPassword'];

    //for customer login query
    $sqlC = "SELECT * FROM client WHERE C_Email = '$Email' and C_Password = '$Password'";
...
//                //for owner login query
    ...
    if ($countC == 1) {
        ...
        header('Refresh: 0; url=OwnerProfile.php');
    } elseif ($countA == 1) {
        //Storing data in session
        $_SESSION['AID'] = $rowA['A_ID'];
